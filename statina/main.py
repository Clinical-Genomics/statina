...
import statina.API.external.api.api_v2.endpoints as external_api_v2
import statina.API.internal.api.api_v1.endpoints as internal_api_v1

external_versions = {"v1": external_api_v1, "v2": external_api_v2}
...
def external(version: str) -> FastAPI:
    ...
    external_app.include_router(api.batches.router, prefix="/batches", tags=["batches"])
